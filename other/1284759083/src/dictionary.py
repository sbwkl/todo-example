...
class Youdao(QObject):
    ...
    def __checkCookie(self):
        if self.cookie:
            rsp = requests.get('http://dict.youdao.com/wordbook/wordlist?tags=无标签', cookies=self.cookie)
    ...
    def getTotalPage(self):
        try:
            rsp = requests.get('http://dict.youdao.com/wordbook/wordlist?tags=无标签', timeout=self.timeout, cookies=self.cookie)
    ...
    def getWordPerPage(self, pageNumber):
        ...
        try:
            ...
            rsp = requests.get(
                'http://dict.youdao.com/wordbook/wordlist?tags=无标签',
                params={'p': pageNumber},
                cookies=self.cookie
            )
